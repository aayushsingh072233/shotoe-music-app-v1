...
const LeftChildren = () => <Image source={require('../../assets/icons/hamburger.png')} resizeMode="contain" elevation={10}/>;

const MiddleChildren = () => <Image source={require('../../assets/shotoe.png')} resizeMode="contain" elevation={10} />;
